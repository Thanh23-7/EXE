...
app.listen(PORT, () => {
    console.log(`GreenFresh backend running at http://localhost:${PORT}`);
});

// --- VNPay Payment Integration (Demo structure, fill merchant info to use real) ---
const crypto = require('crypto');
const vnp_TmnCode = 'YOUR_VNPAY_TMN_CODE'; // Điền mã Merchant
const vnp_HashSecret = 'YOUR_VNPAY_HASH_SECRET'; // Điền secret
