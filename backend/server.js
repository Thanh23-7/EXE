            ...
            db.run('CREATE TABLE products (id INTEGER PRIMARY KEY, name TEXT, price REAL, old_price REAL, description TEXT, category TEXT, image TEXT, origin TEXT, weight TEXT, expiry TEXT, storage TEXT, stock INTEGER)', (err) => {
                ...
                const sampleProducts = [
                    { 
                        ...
                        category: 'Rau củ quả', image: 'https://i.imgur.com/uP1M4yF.jpeg', origin: 'Đà Lạt, Việt Nam', weight: '500g', expiry: '3-5 ngày', storage: 'Tủ lạnh 2-8°C', stock: 47 
                    },
                    { 
                        ...
                        category: 'Rau củ quả', image: 'https://i.imgur.com/wVjJ4Nn.jpeg', origin: 'Đà Lạt, Việt Nam', weight: '300g', expiry: '7 ngày', storage: 'Nơi thoáng mát', stock: 120 
                    },
                    { 
                        ...
                        category: 'Trái cây', image: 'https://i.imgur.com/0v5k6eL.jpeg', origin: 'Nhật Bản', weight: '1kg', expiry: '10 ngày', storage: 'Tủ lạnh', stock: 65 
                    },
                    { 
                        ...
                        category: 'Rau củ quả', image: 'https://i.imgur.com/vHlK3uB.jpeg', origin: 'Sóc Trăng', weight: '5kg', expiry: '12 tháng', storage: 'Nơi khô ráo', stock: 80 
                    },
                    { 
                        ...
                        category: 'Thịt sạch', image: 'https://i.imgur.com/2iG2H0Q.jpeg', origin: 'Úc', weight: '500g', expiry: '2 ngày', storage: 'Đông lạnh', stock: 30 
                    },
                    { 
                        ...
                        category: 'Thịt sạch', image: 'https://i.imgur.com/L8rA5bO.jpeg', origin: 'Việt Nam', weight: '1kg', expiry: '1 ngày', storage: 'Tủ lạnh', stock: 55 
                    },
                    { 
                        ...
                        category: 'Hải sản', image: 'https://i.imgur.com/G5qE7f7.jpeg', origin: 'Nauy', weight: '300g', expiry: '1 ngày', storage: 'Đông lạnh', stock: 20 
                    },
                    { 
